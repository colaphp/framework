...
use Flame\Pusher\Exceptions\PusherException;
...
class PusherApi
{
     ...
     */
    public function __construct($apiAddress, $authKey, $secret)
    {
        $this->checkCompatibility();
        $this->_settings['api_address'] = $apiAddress;
        $this->_settings['auth_key'] = $authKey;
