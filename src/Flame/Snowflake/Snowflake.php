...
class Snowflake
{
    ...
    /**
     * Get start timestamp (millisecond), If not set default to 2024-01-01 00:00:00.
     */
    ...
    {
        return $this->defaultSequenceResolver ?: $this->defaultSequenceResolver = new RedisSequenceResolver();
    }
